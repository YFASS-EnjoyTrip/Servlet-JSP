...
window.addEventListener("load", function () {
  ...
  function makeList(data) {
    ...
    trips.forEach((area) => {
      tripList += `
    <div class="col" onclick="moveCenter(${area.mapy}, ${area.mapx});">
      <div class="card">
        <div class="card-hov">
        <img src="${area.firstimage}" style="height:280px"; class="card-img-top" onerror="this.onerror=null; this.src='./img/blank2.png';">
        </div>
        <div class="card-body">
    ...
    document.getElementById("cardlist").innerHTML = tripList;
    displayMarker();
  }
  ...
  for (let fb of fastbtns) {
    fb.addEventListener("click", () => {
      let keyword = fb.id;
      let searchUrl = `https://apis.data.go.kr/B551011/KorService1/searchKeyword1?serviceKey=${serviceKey}&numOfRows=20&pageNo=1&MobileOS=ETC&MobileApp=AppTest&_type=json&listYN=Y&arrange=A&keyword=${keyword}&contentTypeId=12`;
